 ...
 *
 * @ViewsFilter("entity_context")
 */
class EntityContext extends FilterPluginBase implements ContainerFactoryPluginInterface {
  ...
  public function query() {
    ...
    $query->addWhere($this->options['group'], "$query_base_table.{$keys['id']}", $entity_ids, 'IN');
  }
