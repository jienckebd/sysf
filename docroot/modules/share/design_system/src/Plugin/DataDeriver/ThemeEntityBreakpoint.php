 ...
 *   label = @Translation("Theme entity: breakpoints"),
 *   help = @Translation("Dervive data from breakpoints of a theme.")
 * )
 */
class ThemeEntityBreakpoint extends EntityPluginBase {
  ...
  public function process(array &$data = [], array &$context = []) {
    ...
    $derived_entity_type_id = 'dom';
    $derived_bundle_id = 'breakpoint';
