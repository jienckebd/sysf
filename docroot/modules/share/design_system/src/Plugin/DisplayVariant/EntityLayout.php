...
namespace Drupal\design_system\Plugin\DisplayVariant;
 ...
 * @PageDisplayVariant(
 *   id = "entity_layout",
 *   admin_label = @Translation("Entity layout")
 * )
 */
class EntityLayout extends VariantBase implements PageVariantInterface, ContainerFactoryPluginInterface {
